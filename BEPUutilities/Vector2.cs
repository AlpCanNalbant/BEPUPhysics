...
namespace BEPUutilities
{
    ...
    public struct Vector2(float x, float y) : IEquatable<Vector2>
    {
        ...
        public readonly float Length()
            => (float)System.MathF.Sqrt(X * X + Y * Y);
        ...
        public static void Subtract(ref Vector2 a, ref Vector2 b, out Vector2 difference)
            => difference = new(a.X - b.X, a.Y - b.Y);
        ...
        public static void Multiply(ref Vector2 v, float scale, out Vector2 result)
            => result = new(v.X * scale, v.Y * scale);
        ...
        public static void Divide(ref Vector2 v, float divisor, out Vector2 result)
        {
            ...
            result = new(v.X * inverse, v.Y * inverse);
        }
        ...
        {
            Vector2.Normalize(ref v, out Vector2 toReturn);
            return toReturn;
        }
        ...
        {
            float inverse = 1f / System.MathF.Sqrt(v.X * v.X + v.Y * v.Y);
            result = new(v.X * inverse, v.Y * inverse);
        }
        ...
        public static void Min(ref Vector2 a, ref Vector2 b, out Vector2 min)
            => min = new(a.X < b.X ? a.X : b.X, a.Y < b.Y ? a.Y : b.Y);
        ...
        public static void Max(ref Vector2 a, ref Vector2 b, out Vector2 max)
            => max = new(a.X > b.X ? a.X : b.X, a.Y > b.Y ? a.Y : b.Y);
        ...
        {
            float inverse = (1f / System.MathF.Sqrt(X * X + Y * Y));
            X *= inverse;
            Y *= inverse;
        }
