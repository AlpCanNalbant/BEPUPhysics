...
namespace BEPUphysics.DataStructures
{
    ...
    public class MeshBoundingBoxTree
    {
        ...
        public BoundingBox BoundingBox
            => (root != null) ? root.BoundingBox : new BoundingBox();
        ...
        public bool GetOverlaps(BoundingBox boundingBox, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                root.BoundingBox.Intersects(ref boundingBox, out bool intersects);
                if (intersects)
        ...
        public bool GetOverlaps(BoundingSphere boundingSphere, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                root.BoundingBox.Intersects(ref boundingSphere, out bool intersects);
                if (intersects)
        ...
        public bool GetOverlaps(Ray ray, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                if (ray.Intersects(ref root.BoundingBox, out float result))
        ...
        sealed class InternalNode : Node
        {
            ...
            public override string ToString()
                => "{" + ChildA.ToString() + ", " + ChildB.ToString() + "}";
        ...
        /// </summary>
        public const float LeafMargin = .001f;
        sealed class LeafNode : Node
        {
            readonly int LeafIndex;
