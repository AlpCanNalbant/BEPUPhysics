...
public static class ModelDataExtractor
{
    ...
    {
        GetVerticesAndIndicesFromModel(collisionModel, out Vector3[] tempVertices, out indices);
    ...
    public static void AddMesh(Microsoft.Xna.Framework.Graphics.ModelMesh collisionModelMesh, Matrix transform, List<Vector3> vertices, IList<int> indices)
    {
        foreach (Microsoft.Xna.Framework.Graphics.ModelMeshPart meshPart in collisionModelMesh.MeshParts)
        {
